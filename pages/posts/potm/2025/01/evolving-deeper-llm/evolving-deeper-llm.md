...
![Figure illustrating the Refinement through Critical Conversation process for refining the model response.](./fig-critical-conversation.png){:class="constrained_img_large"}
