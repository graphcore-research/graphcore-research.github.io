...
- LLMs
potm_order: 2
paper_title: Scaling LLM Test-Time Compute Optimally can be More Effective than Scaling
  Model Parameters
paper_authors: Snell et al.
paper_orgs: Berkeley, Google DeepMind
...
![Schematic for how revisions can be generated in parallel or in sequence](./FIG-Revision-Schema.png){:class="constrained_img_large"}

**Example**:

![Example of model generating multiple revisions that guide towards a correct answer](./FIG-Revision-Example.png){:class="constrained_img_large"}
...
![Defining search space to accept/reject generated outputs by learned verifier using beam search with lookahead](./FIG-Verifier-Schema.png){:class="constrained_img_large"}

**Example**:

![At each step the reward model returns a score that guides search amongst possible outputs](./FIG-Verifier-Example.png){:class="constrained_img_large"}
...
![Using reward models to guide search appears to help most for middle difficulty problems with low compute budget. Easy questions are prone to reward model hacking](./FIG-Verifier-Sweep.png){:class="constrained_img_large"}
...
![Learned verifiers can maintain accuracy with 4x less compute in the compute optimal regime](./FIG-Verifier-Optimal.png){:class="constrained_img_small"}
...
![Increasing chain of sequential revisions appears to offer most of the gain as you increase compute budget, although difficult problems do gain some benefit from evaluating parallel chains](./FIG-Revision-Sweep.png){:class="constrained_img_large"}
...
![Learned verifiers can maintain accuracy with 4x less compute in the compute optimal regime](./FIG-Revision-Optimal.png){:class="constrained_img_small"}
