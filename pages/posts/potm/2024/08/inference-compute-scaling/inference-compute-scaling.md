...
![Schematic for how revisions can be generated in parallel or in sequence](./FIG-Revision-Schema.png){:.img-large}

**Example**:

![Example of model generating multiple revisions that guide towards a correct answer](./FIG-Revision-Example.png){:.img-large}
...
![Defining search space to accept/reject generated outputs by learned verifier using beam search with lookahead](./FIG-Verifier-Schema.png){:.img-large}

**Example**:

![At each step the reward model returns a score that guides search amongst possible outputs](./FIG-Verifier-Example.png){:.img-large}
...
![Using reward models to guide search appears to help most for middle difficulty problems with low compute budget. Easy questions are prone to reward model hacking](./FIG-Verifier-Sweep.png){:.img-large}
...
![Learned verifiers can maintain accuracy with 4x less compute in the compute optimal regime](./FIG-Verifier-Optimal.png){.img-small}
...
![Increasing chain of sequential revisions appears to offer most of the gain as you increase compute budget, although difficult problems do gain some benefit from evaluating parallel chains](./FIG-Revision-Sweep.png){:.img-large}
...
![Learned verifiers can maintain accuracy with 4x less compute in the compute optimal regime](./FIG-Revision-Optimal.png){.img-small}
