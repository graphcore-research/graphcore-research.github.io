...
![Training a language model on a Knowledge Graph](./kg-dataset.png){:.img-large}
...
![Hallucination rate improves with training FLOPs](./hallucination-vs-flops.png){:.img-large}
...
![Hallucination rate improves with training FLOPs](./precision-recall-vs-temperature.png){:.img-large}
...
![AUC-OR of hallucination detectors for the output of LMs of different size](./hallucination-detector-AUC-PR.png){:.img-large}
