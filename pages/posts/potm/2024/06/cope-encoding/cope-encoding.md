...
- transformers
potm_order: 3
paper_title: 'Contextual Position Encoding: Learning to Count What’s Important'
...
![CoPE compute contextualized positions, which are not limited to use tokens as unit of measure](./cope_overview.png)
...
![CoPE contextualised attention](./cope_contextualised_attention.png)
...
![CoPE experimental results](./cope_results.png)
...
![CoPE experimental results on longer contexts](./cope_ppl.png)
