...
- quantisation
potm_order: 2
paper_title: 'QuaRot: Outlier-Free 4-Bit Inference in Rotated LLMs'
paper_authors: Saleh Ashkboos, et al.
paper_orgs: ETH Zurich, EPFL, Microsoft Research, IST Austria
...
![QuaRot integration of Hadamard transforms in the attention layer.](./quarot-attention-layer.png)
...
![Llama post-training QuaRot quantisation, using round-to-nearest or GPTQ.](./quarot-results.png)
