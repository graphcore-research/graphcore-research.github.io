...
- LLMs
potm_order: 3
paper_title: 'Mixture-of-Depths: Dynamically allocating compute in transformer-based
  language models'
paper_authors: David Raposo, et al.
paper_orgs: Google DeepMind, McGill University & Mila
...
![Schematic of a transformer layer using Mixture-of-Depths.](./mixture-of-depths-schematic.png)
...
![Comparing MoD and vanilla transformers for a range of FLOP budgets against model parameters and FLOPs per forward pass.](./mixture-of-depths-results.png)
...
![Mixture-of-Depths can be combined with Mixture-of-Experts (MoE) and can outperform vanilla MoE implementations.](./mixture-of-depths-mode.png)
