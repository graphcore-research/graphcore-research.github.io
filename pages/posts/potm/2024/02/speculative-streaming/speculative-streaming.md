...
- LLMs
potm_order: 3
paper_title: 'Speculative Streaming: Fast LLM Inference without Auxiliary Models'
...
![Figure showing the insertion of stream embeddings, tree pruning and tree drafting in the speculative streaming process.](./figure_2.png)
