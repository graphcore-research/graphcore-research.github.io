...
- quantisation
potm_order: 2
paper_title: 'QuIP#: Even Better LLM Quantization with Hadamard Incoherence and Lattice
  Codebooks'
paper_authors: Albert Tseng, Jerry Chee, et al.
paper_orgs: Cornell University
...
![High level scheme for QuIP#: Hadamard transform reduces heavy-tailed-ness, post transformed weights rounded to points on lattice.](./FIG-Scheme.png)
