...
![Schema describing the super weight phenomena on stopword probabilities](./FIG-Schema.png){:class="constrained_img_large"}
...
![Graphs showing how super weights in an LLM are identified](./FIG-Identification.png){:class="constrained_img_large"}
...
![Lookup table for where to find super weights for models hosted on Hugging Face](./TBL-Directory.png){:class="constrained_img_large"}
...
![Table showing that much worse results are achieved when super weights are pruned, whereas only slightly worse results are achieved when large weights are pruned](./TBL-Importance.png){:class="constrained_img_large"}
...
![Super weight removal increases stopword probability and increasing super weight magnitude can improve task performance](./FIG-Ablations.png){:class="constrained_img_large"}
...
![Handling super weights improves block quantisation for larger block sizes](./FIG-BlockQuant.png){:class="constrained_img_large"}
