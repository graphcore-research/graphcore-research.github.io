...
![The mathematical scaling law for precision that is presented](./figure_1.png){:class="constrained_img_large"}
...
![Final validation loss vs. Training precision and Model Size](./figure_2.png){:class="constrained_img_large"}
...
![Post-Quantisaton validation loss vs. Token/Parameter ratio](./figure_3.png){:class="constrained_img_large"}
