...
![Figure showing that near-linear scaling is achieved with Context Parallel with an increasing number of nodes, and that this is not achieved with Tensor Parallel.](./fig-1a.png){:.img-medium}
...
![Figure showing that Time To First Token (TTFT) is halved when moving from 8 CP ranks to 16.](./fig-1b.png){:.img-medium}
