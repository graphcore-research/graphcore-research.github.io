...
- long-context
potm_order: 4
paper_title: Retrieval Augmented Generation or Long-Context LLMs? A Comprehensive
  Study and Hybrid Approach
paper_authors: Zhuowan Li, et al.
paper_orgs: Google DeepMind, University of Michigan
...
![For several state-of-the-art LLMs, long context outperforms RAG, but routing between the two methods can attain similar performance with a fraction of the cost.](./method-comparison.png)
...
![Most of the time, RAG and LC generate the same predictions.](./prediction-distribution.png)
