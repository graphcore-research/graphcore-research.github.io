...
- scaling-laws
potm_order: 3
paper_title: 'Scaling Laws with Vocabulary: Larger Models Deserve Larger Vocabularies'
paper_authors: Chaofan Tao, et al.
paper_orgs: The University of Hong Kong, Sea AI Lab, Contextual AI and The Ohio State
  University
...
![Graph of non-vocab parameters vs vocab parameters with lines showing the scaling predicted by their methods with all three approaches in good agreement. The LLama models are also included on the plot with their vocabulary parameters scaling slower than the optimal rate from this paper.](./figure_1.png)
...
![Fitting results from apprach 1. Power laws are fitted for FLOPs vs non-vocab parameters, vocab parameters and training characters respectively.](./approach_1.png)
...
![A table showing the optimal vocabulary size and vocabulary parameters for various model sizes from 3B to 300B as predicted by their approaches.](./table_1.png)
...
![A table showing the performance of a 2.87B parameter model on a range of benchmarks. By amending the vocab size to their predicted optimum they show an improvement across all benchmarks shown.](./table_2.png)
