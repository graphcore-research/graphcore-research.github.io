...
- sparsity
potm_order: 2
paper_title: Mixture of a Million Experts
...
![For a given compute budget, PEER layers achieve lower test loss compared to dense and mixture-of-experts alternatives](./FIG-Isoflop.png)
...
![A schematic showing the dataflow graph for selecting experts in a PEER layer](./FIG-Schema.png)
...
![Pythonic pseudo-code for implementing the forward method of a PEER layer](./ALGO-PEER.png)
...
![Test perplexity of compute optimal models for a range of open-source large-scale language datasets](./TBL-PPL.png)
...
![Batchnorm appears to help load balance across experts, and gives a small boost to test loss](./TBL-Batchnorm-Balance.png)
