...
paper_orgs: Google DeepMind, New York University
...
![Synthetic dataset generation ](./synthetic.png)
...
![AlphaGeometry system](./alphageometry.png)
...
![Performance of AlphaGeometry on a set of 30 IMO geometry problems.](./IMO_comparison.png){:class="constrained_img"}
