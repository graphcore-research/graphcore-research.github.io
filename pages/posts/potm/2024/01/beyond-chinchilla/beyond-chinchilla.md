...
- LLMs
potm_order: 2
paper_title: 'Beyond Chinchilla-Optimal: Accounting for Inference in Language Model
  Scaling Laws'
...
![The modified chinchilla objective to account for training tokens.](./equation_2.png)
