...
async function attnSelfAttnInit() {
    const img = await attnLoadImage("/assets/images/posts/2024-12/llama-vision/attention_tile.png")
    const attnResponse = await fetch("/assets/images/posts/2024-12/llama-vision/attention.bin")
...
async function attnCrossAttnInit() {
    const img = await attnLoadImage("/assets/images/posts/2024-12/llama-vision/attention_tile.png")
    const attnResponse = await fetch("/assets/images/posts/2024-12/llama-vision/cross_attention.bin")
    const attn = new Float32Array(await attnResponse.arrayBuffer())
