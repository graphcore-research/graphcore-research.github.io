...
image_dir: "/assets/images/posts/2025-10/potm/ltx2/"
review_author:
    name: "Benoit Gaujac"
    link: ""
hidden: true
...
LTX-2 is composed of modality-specific VAEs that encode audio and video into separate latent tracks, a novel text-conditioning module for improved semantic understanding, and an asymmetric dual-stream DiT backbone.

<img src="{{ page.image_dir | append: 'ltx2.png' | relative_url }}" alt="Overview of the LTX-2 architecture.">
...
<img src="{{ page.image_dir | append: 'dual_dit.png' | relative_url }}" alt="Dual stream DiT architecture.">
