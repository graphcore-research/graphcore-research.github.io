...
<img src="{{ page.image_dir | append: 'description.png' | relative_url }}" alt="Example of the different stages of planned diffusion.">
...
<img src="{{ page.image_dir | append: 'attention_mask.png' | relative_url }}" alt="Masking function of the planned diffusion.">
