...
image_dir: "/assets/images/posts/2025-10/potm/grouped-lattice/"
review_author:
    name: "Douglas Orr"
...
<img src="{{ page.image_dir | append: 'algorithm.png' | relative_url }}" class="constrained_img_large" style="max-width: 700px" alt="Algorithm panel for GLVQ, showing the four steps of the quantisation process.">

### Results

A comparison with other post-training quantisation methods on Llama 2 show competitive results at 2-4 bits/param:

<img src="{{ page.image_dir | append: 'results.png' | relative_url }}" alt="Downstream task results grid for GLVQ against baselines, on Llama 2.">
...
<img src="{{ page.image_dir | append: 'performance.png' | relative_url }}" class="constrained_img_large" alt="Table of performance benchmarks for GLVQ dequantisation, versus baselines.">
