...
<img src="{{ page.image_dir | append: 'gaussian-crest-factor.png' | relative_url }}" alt="Crest analysis of block formats on random Gaussian data." class="constrained_img">
