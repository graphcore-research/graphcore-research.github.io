...
tags:
    ...
    - mup
    - optimisation
    - optimization # To editor: can we merge these tags?
    - scaling-laws
potm_year: 2025
potm_month: 11
paper_order: 1  # Editor will decide
image_dir: "/assets/images/posts/2025-11/potm/scaling-second-order/"
review_author:
    name: "Tom Cashman"
...
<img src="{{ page.image_dir | append: 'figure_7a.png' | relative_url }}" alt="Adam vs Muon training for compute vs loss. Muon training runs reach lower loss with equivalent compute.">
