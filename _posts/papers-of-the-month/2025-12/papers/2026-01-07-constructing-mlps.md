...
review_author:
    ...
    link: "https://de.linkedin.com/in/johanna-vielhaben-175b311a3"
hidden: true
---
...
<img src="{{ page.image_dir | append: 'fact-storing-capacity.png' | relative_url }}" alt="Facts-per-parameter scaling.">
