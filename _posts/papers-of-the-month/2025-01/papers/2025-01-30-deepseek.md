...
<table>
  ...
  <tbody>
    ...
    <tr>
      ...
      <td>
      Ablation show an average 2% improvement across benchmarks (extremes: -1%, +8%).
      </td>
    </tr>
    <tr>
      <td>
    ...
    <tr>
      ...
      <td>
      Keeps even loads across experts and makes expert parallelism efficient. DeepSeek use 64-way expert parallelism.
      </td>
      <td>
      Ablations show ~1.5% benchmark improvement, experts specialise more on discernable topics.
      </td>
    </tr>
  </tbody>
</table>
