...
header:
    teaser: /assets/images/posts/2024-07/sparq/schematic.png
    image: /assets/images/posts/2024-07/sparq/schematic.png
    og_image: /assets/images/posts/2024-07/sparq/schematic.png
...
This work was carried out by Luka Ribar, Ivan Chelombiev, Luke Hudlass-Galley, Charlie Blake, Carlo Luschi and Douglas Orr. This work is being presented at ICML 2024, and the paper can be found [here](https://arxiv.org/abs/2312.04985).
...
By varying $r$ and $k$, we can tune the data transfer compression ratio ($`\mathcal{M}_\text{SparQ} / \mathcal{M}_\text{Dense}`$), trading-off approximation accuracy for token generation speed-up.
...
<img src="/assets/images/posts/2024-07/sparq/benchmarking.png" alt="Microbenchmark resutls on the attention operation" width="50%"/>
...
Read the full paper [here](https://arxiv.org/abs/2312.04985), and check out the [poster](https://icml.cc/virtual/2024/poster/34162) at ICML 2024 (poster #511, Wednesday 24th July at 10:30AM).
